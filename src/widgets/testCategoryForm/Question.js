		...
		>
			...
			<div className="col-9 py-2">
				{
					...
					?
					<div>
						<div dangerouslySetInnerHTML={{ __html: this.state.post_title }} />
						<div>
						{
							this.state.bio_biology_theme
								?
								<Tag style={{ backgroundColor : "#8a497f" }} className="mt-2">
									{this.state.bio_biology_theme.post_title}
								</Tag>
								: 
								null
						}
						...
						<div >
							...
							{
								this.state.bio_test && Array.isArray(this.state.bio_test)
									?
									this.state.bio_test.map((e,i) =>
									{
										return <Tag className="m-1" minimal={true} intent={Intent.WARNING}>
											{ e.post_title }
										</Tag>
									})
									: 
					...
					:
					<div className="btn btn-danger" onClick={this.onOpenQuestion}>
						{__("Select Question")}
					</div>
				}
			</div>
			...
			<div className="col-1 py-2"> 
				<Popover
					...
					content={
						<ButtonGroup vertical={true}>
							<Button minimal={true} onClick={this.onOpenQuestion}>
								{__("Change Question")}
							</Button>
